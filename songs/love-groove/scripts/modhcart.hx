...
function postCreate(){
	...
	camHUD.setFilters([new ShaderFilter(threedeez),new ShaderFilter(para)]);
...
{	
	...
	for (i in 0 ... 4){
		...
		ease(10, 0.75,'backOut',"0, x"+i);
		ease(10, 0.75,'backOut',"0, x"+(i+4));
		ease(18, 0.75,'backOut',"-285, y"+i);
		ease(18, 0.75,'backOut',"285, y"+(i+4));
		ease(26, 0.75,'backOut',"240, x"+i);
		ease(26, 0.75,'backOut',"-240, x"+(i+4));
		ease(26, 0.75,'backOut',"285, y"+i);
		ease(30, 1.5,'quadOut',"0, x"+i);
